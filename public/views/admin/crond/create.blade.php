...
@section('content')
    ...
    <div class="am-u-sm-10">
        <form class="am-form am-form-horizontal" action="/crond/save/{{ $group->id }}" method="post">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10 am-form-inline">
                    <div class="am-form-group">
                        <input type="text" class="am-form-field" value="*" style="width: 117px" placeholder="minute" name="run_time[minute]">
                    </div>
                    <div class="am-form-group">
                        <input type="text" class="am-form-field" value="*" style="width: 117px" placeholder="hour" name="run_time[hour]">
                    </div>
                    <div class="am-form-group">
                        <input type="text" class="am-form-field" value="*" style="width: 117px" placeholder="day" name="run_time[day]">
                    </div>
                    <div class="am-form-group">
                        <input type="text" class="am-form-field" value="*" style="width: 117px" placeholder="month" name="run_time[month]">
                    </div>
                    <div class="am-form-group">
                        <input type="text" class="am-form-field" value="*" style="width: 117px" placeholder="week" name="run_time[week]">
                    </div>
                </div>
            </div>
